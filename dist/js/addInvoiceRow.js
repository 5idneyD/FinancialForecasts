var row_number=2,table=document.querySelector(".invoice-body"),number_of_rows_input=document.querySelector("#number_of_rows");number_of_rows_input.value=1;function addRow(){var e=`
 ...
 `;console.log(row_number),row_number+=1,table.insertAdjacentHTML("beforeend",e),table.dataset.rows=row_number-1,number_of_rows_input.value=table.dataset.rows}function addBankRecRow(){var e=`
        <div>
            <div>`+row_number+`
