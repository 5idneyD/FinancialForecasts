...
def signup():
    if request.method == "POST":
        ...
        if Users.query.filter(Users.email == email).first() is None:
            ...
            You are being sent this email to verify that it was you who is signing up to Basic Accounting and ensure nobody is using your
...
def forgotPassword():
    if request.method == "POST":
        ...
        msg_text = f"Hello,\nYou are being sent this email to reset your password at Basic Accounting.\n The code required to set a new password for your email address is : {code}.\n\nIf you have not requested this, please discard this email.\n\nKind regards,\nBasic Accounting"
        msg = f"From: {sender}\r\nTo: {recipient}\r\nsubject: {subject}\r\n{msg_text}\r\n"
        mail.sendmail(sender, recipient, msg)
        mail.quit()
...
def addSalesInvoice(company, email, username, session_key, theme):
    ...
    if request.method == "POST":
        ...
        invoiceTemplate.set_bottom_tip(
            f"Email: {invoice_email}<br/>Please don't hesitate to contact us with any questions <br/> This invoice was generated automatically by Basic Accounting"
        )
        ...
        if request.form["emailSetting"] == "yes":
            ...
            This email has been auto-generated by Basic Accounting.\n
